...
# 최근 변경 내역
- 2020.04.28 레이드 보스, 알 부화 정보 실프로드에서 가져오는 방식  변경, 실프로드 리서치 페이지 변경에 따른 소스 수정 <br>
- 2020.05.07 이벤트,커뮤니티을 서버에서 관리할수 있는 옵션 추가<br>
- 2020.05.11 실프로드 리서치 작업명(한글)을 서버에서 관리하도록 변경함
